...
while i < 5:
    ...
    """),
        SpriteKind.player)
    sprite.set_position(16 + i * 32, 40)
    i += 1
i = 0
while i < 5:
    sprite = sprites.create(img("""
        ...
        """),
        SpriteKind.player)
    sprite.set_position(160, 16 + i * 32)
    i += 1
i = 0
while i < 5:
    sprite = sprites.create(img("""
        ...
        """),
        SpriteKind.player)
    sprite.set_position(16 + i * 32, 16 + i * 32)
    i += 1
# Moving diagonally
# Draw a 3x3 grid of sprites
for y in range(3):
    for x in range(3):
        sprite = sprites.create(img("""
                .............beebbbb............
            ...
            """),
            SpriteKind.player)
        sprite.set_position(160 + x * 32, 120 + y * 32)
i = 0
while i < 7:
    sprite = sprites.create(img("""
            ..............eeeeeee...........
        ...
        SpriteKind.player)
    if i % 2 == 0:
        sprite.set_position(16 + i * 32, 200)
    else:
        # Even positions on the top row
        sprite.set_position(16 + i * 32, 240)
    i += 1