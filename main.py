...
while i < 5:
    sprite = sprites.create(img("""
        ...
        """),
        SpriteKind.player)
    sprite.set_position(16 + i * 18, 10)
    i += 1
i = 0
while i < 5:
    sprite = sprites.create(img("""
        ...
        """),
        SpriteKind.player)
    sprite.set_position(148, 16 + i * 16)
    i += 1
i = 0
while i < 5:
    sprite = sprites.create(img("""
        ...
        """),
        SpriteKind.player)
    sprite.set_position(16 + i * 15, 35 + i * 15)
    # Moving diagonally
    sprite.set_scale(0.6, ScaleAnchor.MIDDLE)
    i += 1
while y < 3:
    x = 0
    while x < 3:
        sprite = sprites.create(img("""
            ...
            """),
            SpriteKind.player)
        sprite.set_position(80 + x * 17, 30 + y * 17)
        # Spacing out grid
...
while y < 1:
    ...
    while x < 3:
        top_sprite = sprites.create(img("""
            ...
            """),
            SpriteKind.player)
        top_sprite.set_position(100 + x * 19, 105)
        top_sprite.set_scale(0.45, ScaleAnchor.MIDDLE)
        x += 1
        sprite2 = sprites.create(img("""
            ...
            """),
            SpriteKind.player)
        sprite2.set_position(119, 85)
        sprite2.set_scale(0.45, ScaleAnchor.MIDDLE)
    y += 1